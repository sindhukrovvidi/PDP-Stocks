...
b. Features that work for flexible portfolio are: (Supported on GUI and text based interface)
       ...
       2. view the portfolio which were created.
       3. see the current value of the portfolio.
       4. throws an IllegalArgumentException if the number of stocks to be entered is less than or
       equal to zero.
       5.Buy and sell after saving the portfolio. (Sells the stocks in the chronological order).
       6. get the cost basis and total composition of portfolio for a specific date.
       7. Performance of the portfolio for a given time range.
       8. Dollar cost averaging - ability to add multiple stocks in portfolio.
